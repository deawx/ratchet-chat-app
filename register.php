...
if(isset($_POST["register"]))
{
    ...
    else
    {
        if($user_object->save_data())
        {
            ...
            // $mail->setFrom('sethakeawmok@gmail.com', 'Nueng Setha');
            ...
            //     <p><a href="http://localhost/ratchet-chat-app/verify.php?code='.$user_object->getUserVerificationCode().'">Click to Verify</a></p>
            //     <p>Thank you...</p>
            // ';
